function show() {
    ...
    /*
    - Além disso, também é possível obter um único elemento através de uma query. O 
    comportamento é igual ao do querySelectorAll(), porém selecionando o primeiro elemento que 
    corresponder à query:
    
    Obs.: Repare que também podemos acessar propriedade internas do elemento obtido.
    
    */

    const firstContact = document.querySelector('#contact-input > li > label')
